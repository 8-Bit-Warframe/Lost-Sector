...
public class Avalanche extends Script {
	...
	public void start() {
		...
		GameObject.instantiate(new GameObject("Avalanche Background",
				new Renderer(ta, ta.getSprite("avalanche_background0"), 800, 300),
				new Animator(Animations.load("warframes/frost/abilities/avalanche", ta, new Validator("background"))),
				new Background()), transform.position);
		GameObject.instantiate(new GameObject("Avalanche Foreground",
				new Renderer(ta, ta.getSprite("avalanche_foreground0"), 800, 300),
				new Animator(Animations.load("warframes/frost/abilities/avalanche", ta, new Validator("foreground"))),
